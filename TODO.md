...
- Combat Damage Feedback V0 and Formation/Aggro Logic V0 are in with attributed damage pops and stronger tank-first threat. Future work should tune readability/threat weights only after playtest data, not add new abilities or classes yet.
