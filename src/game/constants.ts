...
export const GRID_OFFSET_X = 18;
export const GRID_OFFSET_Y = 96;

export const ENTRY_CELL: GridCell = { x: 0, y: 5 };
export const TREASURE_CELL: GridCell = { x: 14, y: 3 };
export const BOSS_CELL: GridCell = { x: 17, y: 9 };
