...
> Vous êtes le monstre final d'un donjon. Chaque expédition repoussée rend le royaume un peu plus intelligent — et votre défaite, un peu plus inévitable.

## 2. Le fantasme central

*Loot Me If You Can* inverse le point de vue classique du dungeon crawler. Le joueur n'incarne pas le héros qui explore — il incarne le Maître du Donjon : celui qui creuse la roche pour façonner son repaire, le garde, et en fait son dernier rempart. Les aventuriers sont les protagonistes de leur propre histoire ; le joueur n'est qu'un obstacle sur leur chemin. Un obstacle qui se souvient d'eux, qui apprend d'eux — mais seulement de ce qu'ils lui laissent découvrir — et qui refuse de mourir facilement.
...
## 3. Les 5 piliers du jeu

Actés lors de la réunion de design #001, ces cinq piliers résument l'identité du jeu en une phrase chacun. Ils orientent toute décision de contenu future, au même titre que les [Design Principles](./DESIGN_PRINCIPLES.md), et sont détaillés section par section dans le [GAME_DESIGN_DOCUMENT.md](./GAME_DESIGN_DOCUMENT.md) §1.

1. **Le joueur est le Maître du Donjon.**
2. **Le Royaume apprend.**
3. **Chaque expédition raconte une histoire.**
4. **La difficulté vient de l'intelligence, jamais du nombre.**
5. **L'information est une ressource.**

> « Chaque nouvelle mécanique doit rendre les expéditions plus mémorables, pas simplement plus difficiles. »

Ces piliers ne remplacent pas les [Piliers d'expérience](#10-piliers-dexpérience) plus bas — ils en sont la formulation la plus condensée, pensée pour trancher vite un débat de design.

## 4. Vision détaillée

*Loot Me If You Can* est un jeu de stratégie et de gestion en temps réel où le joueur alterne entre deux phases : la **préparation** (creuser et aménager le donjon, poser pièges et monstres, gérer son or) et l'**assaut** (regarder — et influencer via les capacités du boss — une expédition de cinq aventuriers tenter de voler le trésor et tuer le boss).

Ce qui distingue structurellement le jeu de ses inspirations, c'est que le monde en face du joueur n'est pas un simple multiplicateur de difficulté. C'est une entité qui **apprend**, mais jamais par magie : elle ne connaît le donjon qu'à travers ce que ses survivants, ses cartographes et ses rumeurs lui rapportent — une guerre de l'information autant qu'une guerre de force (voir [DECISIONS.md](./DECISIONS.md) D-010). Les pièges qui ont tué deviennent des pièges que l'on évite, les rôles qui ont échoué sont remplacés dans la prochaine expédition, les héros tombés reviennent sous forme d'héritiers vindicatifs, et chaque victoire du joueur nourrit malgré elle la légende — donc la préparation — du camp adverse. Mais parce que le joueur peut remodeler son donjon entre deux expéditions, cette connaissance peut aussi devenir fausse : le Royaume prépare ses expéditions sur ce qu'il *croit* savoir, pas sur la vérité du donjon.
...
| **Format de session** | Cycles courts (10–20 minutes par expédition) qui s'enchaînent en sessions longues ; une partie complète se termine par la mort du boss, potentiellement après plusieurs heures. |

## 6. Émotions recherchées

| Émotion | Moment de jeu | Comment on l'obtient |
|---|---|---|
| **Malaise grandissant** | À mesure que la réputation du donjon augmente | Les expéditions montent en compétence de façon lisible : plus de voleurs après un donjon plein de pièges, plus de soigneurs après des combats longs. |
...
| **Orcs Must Die! / Dungeon Warfare** | La boucle poser-des-pièges puis regarder-l'expédition | Le pur réflexe sans mémoire long terme entre les parties |
...
- **Le royaume apprend par l'information, pas par magie.** Ce qu'il sait du donjon vient des survivants, des cartographes et des rumeurs — jamais d'un accès direct à la vérité (voir [DECISIONS.md](./DECISIONS.md) D-010).
...
- **Une seule partie continue.** Pas de reset caché entre les expéditions : ce que le joueur construit et ce que le royaume apprend s'accumulent jusqu'à la fin.

## 9. Ce que le jeu n'est pas

- Ce n'est **pas** un tower defense classique, ni un simple dungeon builder : c'est une guerre de l'information entre un Maître du Donjon et un Royaume qui apprend.
...
*Loot Me If You Can* aura atteint sa vision si, en observant une session, un joueur peut décrire sans notes ce qui vient de se passer sous forme d'anecdote (« ils ont perdu deux guerriers sur mon piège de feu, alors l'expédition suivante ils ont envoyé des voleurs — et l'un d'eux était le fils du guerrier »), et s'il ressent que sa défaite finale, quand elle arrive, est méritée plutôt que subie.
